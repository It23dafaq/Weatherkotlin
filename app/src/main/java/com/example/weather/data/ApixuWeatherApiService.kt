...
const val API_KEY="8aad6d907c39402299380957191005"
//http://api.apixu.com/v1/current.json?key=8aad6d907c39402299380957191005&q=Paris
    ...
    companion object{
        operator fun invoke():ApixuWeatherApiService{
           val requestInterceptor = Interceptor{chain ->
            ...
            return Retrofit.Builder().client(okHttpClient).baseUrl("http://api.apixu.com/v1/").addCallAdapterFactory(CoroutineCallAdapterFactory())
